	...
	<form id="input" method="post">
		<table width="100%" cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<td width="1%">:</td>
				<td>
					<input type="text" id="id_kriteria" name="id_kriteria" required="required" readonly="readonly" value="<?php echo (empty($eks['id_kriteria'])) ?
																																$konf->buat_id("kriteria", "id_kriteria", "K") : $eks['id_kriteria']; ?>">
				</td>
			</tr>
			<tr>
				...
				<td width="1%">:</td>
				<td>
					<input type="text" id="nama_kriteria" name="nama_kriteria" size="25" required="required">
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td width="1%">:</td>
				<td>
					<input type="number" step="0.05" id="bobot_kriteria" name="bobot_kriteria" size="25" required="required">
